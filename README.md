...
The table below tracks the *global*-ranking inside-polygon count. v1.3.0 reframes the analysis to per-region ranking; the global-ranking inside-polygon count remains 0/20 by construction of the global framing, but is no longer the project's headline.
